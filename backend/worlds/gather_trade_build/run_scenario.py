...
Usage:
    python -m worlds.gather_trade_build.run_scenario scenarios/ai_economist_full.yaml
    python -m worlds.gather_trade_build.run_scenario scenarios/ai_economist_full.yaml --seed 123 --epochs 5
"""
